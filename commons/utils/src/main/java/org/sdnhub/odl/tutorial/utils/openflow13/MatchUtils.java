 ...
 * Agosto 2019
 * Nueva funsión para preparar el MatchBuilder sin construirlo
 * Se utiliza en TutorialL2Forwarding para colocar dos direcciones IP como 
 * campos de coincidencia en la entrada que se configura.
 */
...
public class MatchUtils {
    ...
    public static MatchBuilder preconfigL3IPv4Match(MatchBuilder matchBuilder) {
