...
public abstract class AbstractTutorialLearningSwitchModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractTutorialLearningSwitchModule> implements org.sdnhub.odl.tutorial.learningswitch.impl.TutorialLearningSwitchModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.sdnhub.odl.tutorial.learningswitch.impl.AbstractTutorialLearningSwitchModule.class);
    ...
    public AbstractTutorialLearningSwitchModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractTutorialLearningSwitchModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractTutorialLearningSwitchModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractTutorialLearningSwitchModule oldModule){
    ...
    public boolean isSame(AbstractTutorialLearningSwitchModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractTutorialLearningSwitchModule that = (AbstractTutorialLearningSwitchModule) o;
